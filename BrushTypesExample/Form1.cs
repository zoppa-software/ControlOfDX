...
namespace DrawRectangleExample
{
        ...
        : ControlOfDX.VisualForm
    {
        ...
        protected override void OnInitializeResource(EventArgs e)
        {
            ...
            // 薄黄ブラシ
            this.Resources.CreateSolidColorBrush("yellow brush", Color.FromArgb(104, 0x9a, 0xcd, 0x32));

            // ライングラデーション
            var line = this.Resources.CreateLinearGradientBrush("line");
            ...
            // 放射グラデーション
            var radial = this.Resources.CreateRadialGradientBrush("radial");
            ...
            using (var bmp = new Bitmap("..\\..\\fern.jpg")) {
                this.Resources.CreateBitmapBrush("bitmap", (Bitmap)bmp.Clone());
            }
        }
