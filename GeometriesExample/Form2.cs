...
namespace DrawRectangleExample
{
    public partial class Form2 : Form
    {
        ...
        private void mainlControl_InitializeResource(object sender, EventArgs e)
        {
            ...
            // グラデーション
            var grad = this.mainControl.Resources.CreateRadialGradientBrush("grad");
            ...
            // 左の山
            var leftMon = this.mainControl.Resources.CreatePathGeometry("left mountain");
            ...
            // 右の山
            var rightMon = this.mainControl.Resources.CreatePathGeometry("right mountain");
            ...
            var sun = this.mainControl.Resources.CreatePathGeometry("sun geometry");
            ...
            var river = this.mainControl.Resources.CreatePathGeometry("river geometry");
