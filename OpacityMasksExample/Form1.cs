...
namespace DrawRectangleExample
{
        ...
        : ControlOfDX.VisualForm
    {
        ...
        {
            // 矩形ジオメトリを作成
            this.Resources.CreateRectangleGeometry("rectGeo", new RectangleF(0, 0, 148, 148));

            this.Resources.CreateSolidColorBrush("blackBrush", Color.Black);

            using (var bmp = new Bitmap("..\\..\\s1.png")) {
                var linearFadeFlowersBitmap = this.Resources.CreateBitmapBrush("linearFadeFlowersBitmap", bmp);
            ...
            using (var bmp = new Bitmap("..\\..\\s2.png")) {
                var radialFadeFlowersBitmapBrush = this.Resources.CreateBitmapBrush("radialFadeFlowersBitmapBrush", bmp);
            ...
            using (var bmp = new Bitmap("..\\..\\s3.png")) {
                var fernBitmapBrush = this.Resources.CreateBitmapBrush("fernBitmapBrush", bmp);
            ...
            using (var bmp = new Bitmap("..\\..\\s3_mask.png")) {
                this.Resources.CreateBitmap("bitmapMask", bmp);

                var bitmapMaskBrush = this.Resources.CreateBitmapBrush("bitmapMaskBrush", bmp);
            ...
            var linearGradientBrush = this.Resources.CreateLinearGradientBrush("linearGradientBrush");
            ...
            var radialGradientBrush = this.Resources.CreateRadialGradientBrush("radialGradientBrush");
