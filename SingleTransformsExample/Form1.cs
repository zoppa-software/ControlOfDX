...
namespace DrawRectangleExample
{
        ...
        : ControlOfDX.VisualForm
    {
        ...
        protected override void OnInitializeResource(EventArgs e)
        {
            ...
            // ブラシ
            this.Resources.CreateSolidColorBrush("OriginalShapeBrush", Color.DarkBlue);
            this.Resources.CreateSolidColorBrush("FillBrush", Color.White);
            this.Resources.CreateSolidColorBrush("TextBrush", Color.Black);
            this.Resources.CreateSolidColorBrush("TransformedShapeBrush", Color.DarkBlue);
