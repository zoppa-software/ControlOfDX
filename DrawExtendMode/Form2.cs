...
namespace DrawRectangleExample
{
    public partial class Form2 : Form
    {
        ...
        private void mainlControl_InitializeResource(object sender, EventArgs e)
        {
            ...
            // 黒ブラシ
            this.mainControl.Resources.CreateSolidColorBrush("black brush", Color.Black);

            // ビットマップ
            using (var bmp = new Bitmap("..\\..\\Triangle.png")) {
                var bit = this.mainControl.Resources.CreateBitmap("Triangle", bmp);

                var brh = this.mainControl.Resources.CreateBitmapBrush("BitmapBrush", bit);
